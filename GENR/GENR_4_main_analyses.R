...
openxlsx::write.xlsx(els_com, file = file.path(respath, paste0('GENR_SensyResults_',date,'.xlsx')),
                     overwrite=T)
...
openxlsx::write.xlsx(modls, file = file.path(respath, paste0('GENR_Revision1_',date,'.xlsx')),
                     overwrite=T)
